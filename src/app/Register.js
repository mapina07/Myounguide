...
class Register extends Component{
    ...
    handleSubmit(e){
        e.preventDefault();
        let error=null;
        if((this.state.email=='')||(this.state.repassword=="")||(this.state.password=="")){
        ...
        if(error){
            ...
            this.props.onSingup(this.state.email,this.state.password,this.state.name);
                ...
                <div className="register-box">
                    ...
                    <div className="register-box-body">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group has-feedback">
                                <input type="email" name="email" value={this.state.value} title="Debe ser en formato de correo electrónico. Incluya @." onChange={this.handleInputChange} className="form-control" placeholder="Correo"></input>
                            ...
                            <div className="row">
                                <div className="col-xs-12">
                                    <button type="submit" className="btn btn-primary btn-block btn-flat">Registrar</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
const mapDispatchToProps=dispatch=>{
    return{
        onSingup:(email,password,name)=>dispatch(actions.authRegister(email,password,name))
    }
}
